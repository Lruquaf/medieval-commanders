...
UPDATE "cards" SET "birthYear" = EXTRACT(YEAR FROM "birthDate") WHERE "birthDate" IS NOT NULL;
UPDATE "cards" SET "deathYear" = EXTRACT(YEAR FROM "deathDate") WHERE "deathDate" IS NOT NULL;
UPDATE "proposals" SET "birthYear" = EXTRACT(YEAR FROM "birthDate") WHERE "birthDate" IS NOT NULL;
UPDATE "proposals" SET "deathYear" = EXTRACT(YEAR FROM "deathDate") WHERE "deathDate" IS NOT NULL;
